...
<body>
    ...
    <article>
        ...
        <section>
            <div class="kontakt">
              <p >Dotaz na ubytování na tel: <b>+420 603 355 325</b>  nebo  e-mail: <strong>u.mustku@seznam.cz</strong></p>
            </div> 
            ...
            <div>
                ...
                <form action="mailer.php" method="post" class="box">
                    ...
                    if($_GET['success'] == -1){
                        echo "<div class=\"form-result error\">Odeslání proběhlo v pořádku.</div>";
                    };
                    ...
                    <textarea name="message" placeholder="Vaše zpráva" cols="30" rows="10"></textarea> 
